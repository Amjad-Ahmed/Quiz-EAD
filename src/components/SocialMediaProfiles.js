    ...
    return (
       <div style={{backgroundColor: '#d7d7d7'}} className={"align-items-center p-4"}>
           <div className="d-flex align-items-center justify-content-center">
               <a href="https://github.com/Amjad-Ahmed">
               ...
               <div className="ms-4">
                   <a href="https://www.linkedin.com/in/amjad-ahmed-am110/">
                       <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#0073b2" className="bi bi-linkedin"
                            viewBox="0 0 16 16">
                           <path
